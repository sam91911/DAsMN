...
class TimeSortedFileSystem:
    ...
    def store_file(self, user, data, timestamp=None):
        ...
        user_dir = os.path.join(self.base_dir, year, month, day, user)
    ...
    def get_data_within_time_range(self, start_time, end_time=None, users=None):
        if end_time is None:
